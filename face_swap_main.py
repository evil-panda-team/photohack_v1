...
from face_swap.face_detection import face_detection
from face_swap.face_points_detection import face_points_detection
from face_swap.face_swap import warp_image_2d, warp_image_3d, mask_from_points, apply_mask, correct_colours, \
...
def face_swapper(src_img, dst_img, warp_2d=False, correct_color=False, no_debug_window=True, out='results/result.jpg',
                 text=None):
    ...
    if text is not None:
        cv2.putText(output, text, (10, whc[0]-10), cv2.FONT_HERSHEY_TRIPLEX, 1.4, (255, 255, 255), 1, cv2.LINE_AA)
...
if __name__ == '__main__':
    ...
    # Read images
    src_img = cv2.imread('data/images/selfies/rafa.jpg')
    dst_img = cv2.imread('data/images/selfies/pavel.jpg')
    face_swapper(src_img, dst_img)
